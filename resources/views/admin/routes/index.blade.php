...
<body>
    <div class="container">
        ...
        <div class="stats">
            ...
            <div class="stat-card danger">
                <h3>Admin فقط</h3>
                <p>{{ $stats['admin_only'] }}</p>
            </div>
            <div class="stat-card primary">
                <h3>مع Rate Limit</h3>
                <p>{{ $stats['with_rate_limit'] }}</p>
            </div>
            <div class="stat-card success">
                <h3>Controllers</h3>
                <p>{{ $stats['unique_controllers'] }}</p>
            </div>
        </div>
        ...
        <form method="GET" class="filters">
            ...
            <div class="filter-checkboxes">
                <label class="checkbox-label">
                    <input type="checkbox" name="is_api" value="1" {{ request('is_api') ? 'checked' : '' }}>
                    <span>API Routes فقط</span>
                </label>
                <label class="checkbox-label">
                    <input type="checkbox" name="is_public" value="1" {{ request('is_public') ? 'checked' : '' }}>
                    <span>المسارات العامة فقط</span>
                </label>
                <label class="checkbox-label">
                    <input type="checkbox" name="requires_admin" value="1" {{ request('requires_admin') ? 'checked' : '' }}>
                    <span>Admin فقط</span>
                </label>
            </div>
            ...
            <div class="filters-actions">
                ...
                <a href="{{ route('admin.routes') }}" style="text-decoration: none;">
        ...
        <div class="route-card">
            <div class="route-header" onclick="toggleDetails(this)">
                ...
                <div class="route-badges">
                    ...
                    @if($route['rate_limit'])
                    <span class="badge badge-rate-limit">{{ $route['rate_limit'] }}</span>
                    @endif
            ...
            <div class="route-details">
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-grid">
                        <div class="detail-item">
                            ...
                            <span>{{ $route['controller'] ?? 'Closure' }}</span>
                        </div>
                        <div class="detail-item">
                        ...
                        <div class="detail-item">
                            ...
                            <span>{{ Str::limit($route['action'], 50) }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="detail-section">
                    <h4>🛡️ Middleware ({{ count($route['middleware']) }})</h4>
                    <div class="middleware-list">
                        @foreach($route['middleware'] as $middleware)
                        <span class="middleware-item">{{ $middleware }}</span>
                        @endforeach
                    </div>
                </div>
                @endif
                ...
                <div class="detail-section">
                    <h4>📝 Parameters ({{ count($route['parameters']) }})</h4>
                    <div class="param-list">
                        ...
                        <div class="param-item">
                            ...
                            <span style="color: #9ca3af; font-size: 11px;"> = {{ json_encode($param['default']) }}</span>
                            @endif
                        </div>
                        @endforeach
                    </div>
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-item">
                        ...
                        <span>{{ $route['documentation']['description'] }}</span>
                        @endif
                    </div>
                </div>
                @endif
